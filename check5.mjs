...
const result = await supabase.from('movies').select('id,title,ott_providers').not('ott_providers','is',null).limit(5);
console.log('Movies with OTT:', JSON.stringify(result.data, null, 2));
